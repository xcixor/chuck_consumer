...
test:
	docker-compose up --build --force-recreate --remove-orphans --detach
	docker-compose run chuck-consumer coverage erase --rcfile=.coveragerc
	docker-compose run chuck-consumer coverage run --rcfile=.coveragerc manage.py test
	docker-compose run chuck-consumer coverage report --rcfile=.coveragerc
